...
public class Experiment4_3_2 extends Experiment4 {
    @Override
    ...
    public Map<String, Boolean> getSyncSendMap() {
        ...
        sendMap.put("runnable3_start", true);
        sendMap.put("runnable3_finish", true);
        sendMap.put("runnable4_start", true);
        sendMap.put("runnable4_finish", true);
    ...
    public List<Template> getM2() throws IOException {
        List<Template> list = new ArrayList<>();
        Template template = VerificationUtil.transToUppaal(Experiment4Util.buildComponent1_2_2());
...
//        String s0 = "[beforeAfter]:(runnable4_start, runnable4_finish)";
        String s1 = "[beforeAfter]:(runnable3_start, runnable3_finish)";
