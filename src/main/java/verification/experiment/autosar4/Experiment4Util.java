...
public class Experiment4Util {
    ...
    public static Template buildRunnable2() {
        ...
        InvariantLabel label = new InvariantLabel();
        label.setText("x<4");
        s3.setInvariantLabel(label);
        s4.setInvariantLabel(label);
        s5.setInvariantLabel(label);
        UppaalTransition t1 = new UppaalTransitionBuilder(s1, s2)
    ...
    public static DOTA buildComponent1_1() throws IOException {
...
//        schedule = DOTAUtil.getCartesian(schedule, task1);
        ...
        return DOTAUtil.getDOTAFromJsonFile(schedulePath);
